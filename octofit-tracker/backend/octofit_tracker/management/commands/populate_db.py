...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        app_models.Workout.objects.create(name='Pushups', description='Upper body workout')
        app_models.Workout.objects.create(name='Squats', description='Lower body workout')
